<template>
 ...
 <div class="md:col-span-2">
   <h3 class="text-2xl font-bold text-black mb-4">Dịch Vụ Giá Trị Gia Tăng (VAS) – Giải Pháp Nâng Cao Hiệu Quả Kinh Doanh</h3>
   ...
   <h3 class="text-xl font-bold text-black mb-4 mt-10">Giới Thiệu Dịch Vụ Giá Trị Gia Tăng
   ...
   <h3 class="text-xl font-bold text-black mb-4 mt-10">Lợi Ích Khi Sử Dụng Dịch Vụ Giá Trị Gia Tăng
   ...
   <h3 class="text-xl font-bold text-black mb-4 mt-10">Liên Hệ Để Triển Khai Dịch Vụ
