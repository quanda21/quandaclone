<template>
    ...
    <ul class="flex space-x-6 list-none">
      ...
      <li class="relative group">
        ...
        <ul class="absolute hidden group-hover:block bg-white shadow-md mt-1 rounded w-80 text-left z-10">
              ...
              <li>
                <router-link to="/dich-vu-GTVT" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                  Dịch vụ GTGT
                </router-link>
              </li>
              <li>
  ...
  <ul class="absolute left-0 top-full mt-2 hidden group-hover:block bg-white shadow-lg rounded w-56 z-50">
    <li>
      <a href="/giai-phap/tong-dai-voip" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
        Tổng đài VoIP
      </a>
    </li>
    <li>
      <a href="/giai-phap/tong-dai-tin-nhan" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
        Tổng đài tin nhắn
      </a>
    </li>
    <li>
      <a href="/giai-phap/thu-dien-tu" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
        Thư điện tử
      </a>
    </li>
  </ul>
 ...
 <div class="md:col-span-2">
   <h3 class="text-2xl font-bold text-black mb-4">Giải Pháp Tổng Đài Tin Nhắn SMS</h3>
   ...
   <h3 class="text-xl font-bold text-black mb-4 mt-10">Hạ Tầng SMS Ổn Định & Mạnh Mẽ
   </h3>
   <p class="text-gray-600">
   ...
   <h3 class="text-xl font-bold text-black mb-4 mt-10">Kiểm Soát Hiệu Quả & Báo Cáo Chi Tiết
   </h3>
   <p class="text-gray-600">
   ...
   <h3 class="text-xl font-bold text-black mb-4 mt-10">Chi Phí Cạnh Tranh & Hỗ Trợ 24/7
